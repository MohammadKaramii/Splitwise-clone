            ...
            <div className='social-left'>
              <div>
                <button className='facebook'>
                  <img src='https://secure.splitwise.com/assets/fat_rabbit/social/facebook.png' alt='Facebook' />
                  Share
                </button>
              </div>
              <div>
                <button className='tweet'>
                  <img src='https://secure.splitwise.com/assets/fat_rabbit/social/twitter.png' alt='Twitter' />
                  Tweet
                </button>
              </div>
            </div>
